...
import { MobileMenu } from "../SVG/svg";

const NavLeftList = ({ value }) => {
  return (
    <div className="flex">
        ...
        <div className="flex h-16 items-center">
          ...
          <div className="hidden lg:ml-8 lg:block lg:self-stretch">
            <div className="flex h-full space-x-8">
              <NavLeftList value="Woman" />
              <NavLeftList value="Man" />

              <NavLeftBtn value="Company" />
              <NavLeftBtn value="Stores" />
            </div>
          </div>
